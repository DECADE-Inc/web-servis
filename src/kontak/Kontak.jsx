  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-white relative z-10 inline-block rounded-lg animate-slideInRight">
          Hubungi kami
        </h1>
      </section>
      <div
      ...
      <div className="mx-auto max-w-2xl text-center mt-5">
        <h2 className="text-2xl font-semibold tracking-tight text-balance text-gray-900">Service Center Elecktrolux</h2>
      </div>
